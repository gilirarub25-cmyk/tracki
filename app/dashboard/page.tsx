  ...
  return (
    <div className="p-6 md:p-8 max-w-7xl mx-auto w-full space-y-6">
      ...
      <header className="mb-8">
        <h1 className="text-3xl font-semibold text-[#dde4dd]">Hola, <span className="capitalize">{userName}</span> 👋</h1>
        <p className="text-[#bbcabf] mt-1">Aquí tienes tu resumen financiero, aún no tienes movimientos.</p>
      </header>

      {/* Tarjetas Superiores (Vacías por ahora) */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className={glassCard}>
          <p className="text-[10px] uppercase font-bold text-[#bbcabf] tracking-wider mb-2">Ingresos</p>
          <h2 className="text-3xl font-bold text-[#4edea3]">0.00 €</h2>
        </div>
        <div className={glassCard}>
          <p className="text-[10px] uppercase font-bold text-[#bbcabf] tracking-wider mb-2">Gastos</p>
          <h2 className="text-3xl font-bold text-[#ffb4ab]">0.00 €</h2>
        </div>
        <div className={glassCard}>
          <p className="text-[10px] uppercase font-bold text-[#bbcabf] tracking-wider mb-2">Balance</p>
          <h2 className="text-3xl font-bold text-[#dde4dd]">0.00 €</h2>
        </div>
      </div>
